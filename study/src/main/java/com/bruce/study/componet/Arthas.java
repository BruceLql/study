package com.bruce.study.componet;
...
/*
 * 原文链接：https://blog.csdn.net/u013735734/java/article/details/102930307
 *@ClassName Arthas
 *@Description TODO
 *@Author Bruce
...
@Component
public class Arthas {
    private final static Logger log = LoggerFactory.getLogger(Arthas.class);
