package com.bruce.study.util;
/*
 *@ClassName JavaWebTokenUtil
 *@Description 原文链接：https://blog.csdn.net/east123321/java/article/details/79799287
 *@Author Bruce
 *@Date 2020/6/27 1:27
 *@Version 1.0
 */

import com.bruce.study.jwt.JWTDemo;
...
public class JavaWebTokenUtil {
    ...
    public static void main(String[] args) {
        String jwt = createJWT("123456", "Bruce", "ok", System.currentTimeMillis());
